...
variable "load_balancers" {
  description = "This is the load balancers definition map."
  type        = map(any)
  default     = {}
}

variable "lb_ips_asoc" {
  description = "Adds IP addresses to LB backend address pool."
  type        = map(any)
  default     = {}
}

variable "lb_nics_asoc" {
  description = "Adds NIC to LB backend address pool."
  type        = map(any)
  default     = {}
}