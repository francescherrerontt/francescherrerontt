...
variable "vm_scale_set_w" {
  description = "This is the windows scale set definition map"
  type        = map(any)
  default     = {}
}

variable "vm_scale_set_l" {
  description = "This is the linux scale set definition map"
  type        = map(any)
  default     = {}
}
