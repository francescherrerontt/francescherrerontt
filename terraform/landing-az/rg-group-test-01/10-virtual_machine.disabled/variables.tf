...
variable "virtual_machines_w" {
  description = "This is the windows virtual machines definition map"
  type        = map(any)
  default     = {}
}

variable "virtual_machines_l" {
  description = "This is the linux virtual machines definition map"
  type        = map(any)
  default     = {}
}
...
variable "extra_disks" {
  description = "List of extra data disks attached to each virtual machine."
  type = list(object({
    name = string
    size = number
  }))
...
variable "custom_stdiag_name" {
  description = "Custom name for storage account for diagnostics"
  type        = string
  default     = null
}
